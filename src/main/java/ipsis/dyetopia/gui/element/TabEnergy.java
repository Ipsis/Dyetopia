...
public class TabEnergy extends TabBase {
    ...
    public void draw() {
        ...
        getFontRenderer().drawStringWithShadow(StringHelper.localize(Lang.ENERGY_DRAW) + ":", posXOffset() + 6, posY + 20, subheaderColor);
        ...
        getFontRenderer().drawStringWithShadow(StringHelper.localize(Lang.ENERGY_RX_TICK) + ":", posXOffset() + 6, posY + 44, subheaderColor);
        getFontRenderer().drawString(energyInfo.getInfoMaxEnergyPerTick() + " RF/t", posXOffset() + 14, posY + 56, textColor);

        getFontRenderer().drawStringWithShadow(StringHelper.localize(Lang.ENERGY_STORED) + ":", posXOffset() + 6, posY + 68, subheaderColor);
    ...
    private String getTitle() {
        ...
        return StringHelper.localize(Lang.TAB_ENERGY_TITLE);
    }
